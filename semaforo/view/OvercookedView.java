...
import semaforo.controller.OvercookedController;

public class OvercookedView {

	public static void main(String[] args) {
		int limitador = 5;
		Semaphore semaforoCozimento = new Semaphore(limitador);
		Semaphore semaforoEntrega = new Semaphore(1);
		for (int id = 0; id < 10; id++) {
			Thread overcooked = new OvercookedController(id, semaforoCozimento, semaforoEntrega);
			overcooked.start();
		}
	}
